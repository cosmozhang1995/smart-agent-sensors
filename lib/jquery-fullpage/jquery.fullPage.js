...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$.fn.fullpage.moveSlideRight = function(callback){
			moveSlide('next', callback);
		};

		$.fn.fullpage.moveSlideLeft = function(callback){
			moveSlide('prev', callback);
		};
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
				...
				if (options.controlArrow) $(this).find('.fp-slides').after('<div class="fp-controlArrow fp-prev"></div><div class="fp-controlArrow fp-next"></div>');

				if(options.controlArrow && options.controlArrowColor!='#fff'){
				...
				if(options.controlArrow && !options.loopHorizontal){
		...
		*/
		...
		function moveSlide(direction, callback){
		    ...
		    landscapeScroll(slides, destiny, callback);
		}
		...
		*/
		function landscapeScroll(slides, destiny, callback){
